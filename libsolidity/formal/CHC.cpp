...
void CHC::endVisit(ContractDefinition const& _contract)
{
	...
	addVerificationTarget(m_currentContract, m_currentBlock, smtutil::Expression(true), m_error.currentValue());
...
void CHC::addVerificationTarget(ASTNode const* _scope, smtutil::Expression _from, smtutil::Expression _constraints, smtutil::Expression _errorId)
{
